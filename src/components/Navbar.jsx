      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex items-center justify-between h-20'>
          ...
          <div className='hidden md:flex items-center justify-center flex-1 '>
            <div className={`${isSearchActive ? 'w-full max-w-md' : 'w-auto'} transition-all duration-300`}>
              <div className='bg-white border relative border-gray-300 rounded-full shadow-md p-3 flex items-center hover:shadow-lg transition-shadow'>
                ...
                <input
                  type='text'
                  placeholder={isSearchActive ? 'Where are you going?' : 'Add guests'}
          ...
          <div className='flex items-center space-x-4'>
            ...
            <div className='relative 'ref={menuRef}>
              <button
                ...
                className='flex items-center cursor-pointer space-x-2 border border-gray-300 rounded-full py-2 px-4 hover:shadow-md transition'
              >
              ...
              {isProfileOpen && (
                <div className='absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl z-10 py-1'>
                  <Link to="/auth/signup" className='block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100'>Sign Up</Link>
                  <Link to="/auth/signin" className='block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100'>Log In</Link>
                  <hr className='my-1' />
                  <a href='#' className='block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100'>Become a host</a>
