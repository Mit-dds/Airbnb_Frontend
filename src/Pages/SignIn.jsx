    ...
    <div className="min-h-screen flex items-center justify-center ">
      <main className="w-full flex justify-center px-4 py-12">
        <div className="w-lg max-w-md border border-gray-200 rounded-lg bg-white p-8 shadow-md">
          ...
          <p className="mb-4 text-gray-600">Welcome back - please enter your details.</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-between items-center mt-4">
              <label className="flex items-center gap-2 text-sm">
                <input type="checkbox" className="accent-pink-500 cursor-pointer " /> <span>Remember me</span>
              </label>
              <Link to="/signin" className="text-sm text-blue-600 hover:underline">Forgot?</Link>
            </div>
          ...
          <p className="mt-6 text-sm text-center">Don't have an account? <Link to="/auth/signup" className="text-pink-600 hover:underline">Create One</Link></p>
        </div>
      </main>
    </div>
  )
